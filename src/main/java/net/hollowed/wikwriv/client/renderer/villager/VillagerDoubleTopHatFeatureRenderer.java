...
public class VillagerDoubleTopHatFeatureRenderer extends FeatureRenderer<VillagerEntity, VillagerResemblingModel<VillagerEntity>> {
    ...
    public VillagerDoubleTopHatFeatureRenderer(FeatureRendererContext<VillagerEntity, VillagerResemblingModel<VillagerEntity>> context, ModelPart modelPart) {
        super(context);
